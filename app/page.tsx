...
export default function Home() {
  return (
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans ">
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-6 px-16 sm:items-start">
        <h1 className="text-4xl font-bold text-center text-gray-700 p-2">
        ...
        <p className="text-lg text-center text-gray-800 py-6">
